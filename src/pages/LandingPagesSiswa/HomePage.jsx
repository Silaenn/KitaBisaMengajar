...
import Siswa9 from "../../assets/Siswa/Siswa9.png";
        ...
        <div className="grid md:grid-cols-2 gap-8 items-center">
          ...
          <div className="max-w-xl mb-16">
            <h2 className="text-[36px] leading-tight font-bold text-gray-800 mb-6">
              Mari Belajar dan Menggapai Mimpi Bersama!
            </h2>
            <p className="text-[16px] text-paragraf-secondary font-medium mb-8">
              KitaBisaMengajar adalah platform yang memberikan kesempatan bagi
              siswa di seluruh Indonesia untuk belajar langsung dari guru
              relawan. Melalui pembelajaran jarak jauh, kami membantu siswa
              mencapai potensi terbaik dan meraih mimpi tanpa batasan jarak.
            </p>
            ...
            <div>
              ...
              <p className="text-sm text-blue-600">
                Ayo gabung bersama 50.000 siswa yang sudah memulai <br />{" "}
