...
import Siswa10 from "../../assets/Siswa/Siswa10.png";
          ...
          <div className="text-center">
            ...
            <div className="flex justify-center mt-6">
              <StepCard
                ...
                description="Bergabunglah dan mulai belajar tanpa batasan jarak."
                icon="user"
              />
            </div>
            <div className="mt-6 grid grid-cols-1 sm:grid-cols-2 gap-10">
              <div className="flex justify-center">
                <StepCard
                  ...
                  description="Pilih pelajaran yang sesuai dengan minat dan kebutuhanmu."
                  icon="subject"
                />
              </div>
              <div className="flex justify-center">
                <StepCard
                  title="Mulai Belajar"
                  description="Akses kelas virtual interaktif dengan guru yang siap membimbing."
                  icon="teach"
                />
              </div>
            </div>
