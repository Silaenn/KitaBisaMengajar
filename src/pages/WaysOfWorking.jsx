  ...
  const icons = {
    ...
    subject: (
      <svg
        ...
        viewBox="0 0 24 24"
      >
        <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-1.1 0-2-.9-2-2s.9-2 2-2 2 .9 2 2-.9 2-2 2zm0-16c-3.87 0-7 3.13-7 7s0,1.74,.63,3.33,1.68,4.57L4.7,18.34a,.996,.996,0,1,0,1.41,1.41l2.11,-2.11C10.67,18.37,12.32,19,14,19c3.87,0,7,-3.13,7,-7s -3.13,-7,-7,-7z" />
      </svg>
    ),
    teach: (
      <svg
        ...
        viewBox="0 -5,24,24"
      >
        <path d="M12,2 C6.49,2,2,6.49,2,12s4.49,10,10,10,10,-4.49,10,-10S17.51,2,12,2zm0,4c1.66,0,3,1.34,3,3s -1.34,3,-3,3 -3,-1.34,-3,-3S10.34,6,12,6zm -7,8c0,-1 .34,-2 .5,-3 .66,-1 .84,-1 .84,-1H19v8H5v -4z" />
      </svg>
    ),
  };
